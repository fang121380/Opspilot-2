...
- [ ] Delivery: commit reviewed patches, push branch and update main by fast-forward when checks pass; refresh local deployment and launcher; verify both local and LAN origins. Never rewrite remote history or change unrelated clusters.
