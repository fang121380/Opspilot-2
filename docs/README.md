# Opspilot 2 文档索引 / Documentation Index

项目文档按中文和英文成对维护。中文版本方便中文学习和面试准备，英文版本保留同一套命令、接口和安全边界，适合公开仓库协作。

Project documentation is maintained in Chinese and English pairs. Chinese pages are optimized for local learning and interviews; English pages preserve the same commands, APIs, and safety boundaries for public collaboration.
...
Code, API paths, configuration keys, and Kubernetes resource names intentionally use English engineering names. Explanations and operational steps are available in both languages.
